<?php /*a:1:{s:52:"D:\phpstudy_pro\wz\tp-admin\app\v2\view\v2\login.php";i:1698032654;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="layui-form-item">
                <div class="layui-input-wrap">
                    ...
                    <input type="text" name="username" value="" lay-verify="required" placeholder="用户名"
                        lay-reqtext="请填写用户名" class="layui-input" lay-affix="clear">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-wrap">
